      ...
      <div className="bg-white rounded-lg p-4">
        ...
        <div className="border-t border-b py-3 mb-4">
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
            {room.Inclusion?.split(',').slice(0, 6).map((amenity, index) => (
